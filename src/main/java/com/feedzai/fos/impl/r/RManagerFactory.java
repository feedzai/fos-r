...
/**
 * Factory for creating r managers.
 *
 * @author miguel.duarte
 * @since 1.0.2
 */
public class RManagerFactory implements ManagerFactory {

    @Override
    public Manager createManager(FosConfig configuration) throws FOSException {
        RManagerConfig rManagerConfig = new RManagerConfig(configuration);
